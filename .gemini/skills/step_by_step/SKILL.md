...
This skill breaks down a task or request into a clear, actionable, step-by-step process.

## Instructions

When invoked to provide a step-by-step guide or process, follow these guidelines:
